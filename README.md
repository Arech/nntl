...
### Cons
* I wouldn't say that NNTL is a Plug-n-Play system. It's a kind of framework to build fast neural networks and experiment with them. If you just want to play with NN, it's better to take something more suitable like DeepLearnToolbox for Matlab or Theano for Python. TensorFlow or DMTK is great if you have a lot of computing power.
